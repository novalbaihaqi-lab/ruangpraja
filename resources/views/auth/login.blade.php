...
<body class="min-h-screen bg-gray-50 flex">
    ...
    <div class="hidden lg:flex w-1/2 flex-col justify-between p-12" style="background: #1a4d2e;">
        ...
        <div>
            <h2 class="text-4xl font-bold text-white leading-tight mb-6" style="font-family:'Plus Jakarta Sans',sans-serif;">
                Belajar bersama,<br>
                <span class="italic text-green-300">tumbuh bersama.</span>
            </h2>
            <p class="text-green-200 text-sm leading-relaxed mb-10">
                Platform webinar dan diklat resmi Satuan Polisi Pamong Praja Provinsi Jawa Timur.
            </p>

            {{-- TESTIMONI --}}
            <div class="border border-green-700 rounded-2xl p-6" style="background: rgba(255,255,255,0.05);">
                <p class="text-green-100 text-sm italic leading-relaxed mb-4">
                    "Ruang Praja sangat memudahkan kami untuk mengikuti webinar dan mendapatkan sertifikat tanpa menunggu lama."
                </p>
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-green-600 flex items-center justify-center text-white text-xs font-bold">S</div>
                    <div>
                        <div class="text-white text-xs font-semibold">Anggota Satpol PP</div>
                        <div class="text-green-400 text-xs">Peserta Kejarsiroma</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="flex-1 flex items-center justify-center p-8">
        <div class="w-full max-w-md">
            ...
            <form method="POST" action="/login" class="flex flex-col gap-5">
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="remember" id="remember" class="w-4 h-4 rounded" style="accent-color:#1a4d2e;">
        ...
        <div class="flex items-center gap-3 my-6">
            ...
            <span class="text-xs" style="color:#9ca3af;">atau masuk dengan</span>
            <div class="flex-1 h-px" style="background:var(--border-color, #e5e7eb);"></div>
        </div>
        ...
        style="border-color:#e5e7eb; color:#374151;">
            ...
            <p class="text-center text-sm text-gray-400 mt-8">
                Belum punya akun?
                <a href="/register" class="font-semibold hover:underline" style="color:#1a4d2e;">Daftar sekarang</a>
            </p>
        </div>
    </div>
